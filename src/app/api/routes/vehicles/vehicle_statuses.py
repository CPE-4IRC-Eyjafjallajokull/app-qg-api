...
@router.get("", response_model=list[VehicleStatusRead])
...
@router.get("/{vehicle_status_id}", response_model=VehicleStatusRead)
...
@router.patch("/{vehicle_status_id}", response_model=VehicleStatusRead)
