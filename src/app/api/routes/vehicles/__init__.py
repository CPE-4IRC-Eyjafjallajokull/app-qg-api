...
from app.api.routes.vehicles.consumable_types import router as consumable_types_router
...
from app.api.routes.vehicles.stock import router as stock_router
from app.api.routes.vehicles.type_consumable_specs import (
    router as type_consumable_specs_router,
)
...
router.include_router(type_consumable_specs_router)
